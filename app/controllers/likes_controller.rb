class LikesController < ApplicationController
  ...
  def create
    ...
    if the_like.valid?
      ...
      redirect_to(root_path, { :alert => the_like.errors.full_messages.to_sentence })
    end
  end
  ...
  def destroy
    ...
    if the_like
      the_like.destroy
      redirect_to(root_path, { :alert => "Photo unliked." })
    else
      redirect_to(root_path, { :alert => "Failed to unlike photo." })
    end
  end
end
